...
public class ResponseModel  implements java.io.Serializable {
    ...
    private cl.inexcell.sistemadegestion.webservices.ServiceModelOut service;
    ...
    public ResponseModel(
           ...
           cl.inexcell.sistemadegestion.webservices.ServiceModelOut service,
    ...
    /**
     * Gets the operation value for this ResponseModel.
     * 
     * @return operation
     */
    ...
    /**
     * Sets the operation value for this ResponseModel.
     * 
     * @param operation
     */
    ...
    /**
     * Gets the service value for this ResponseModel.
     * 
     * @return service
     */
    public cl.inexcell.sistemadegestion.webservices.ServiceModelOut getService() {
        return service;
    }


    /**
     * Sets the service value for this ResponseModel.
     * 
     * @param service
     */
    public void setService(cl.inexcell.sistemadegestion.webservices.ServiceModelOut service) {
        this.service = service;
    }


    /**
     * Gets the _return value for this ResponseModel.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this ResponseModel.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:Demo", "ResponseModel"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:Demo", "ServiceModelOut"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
